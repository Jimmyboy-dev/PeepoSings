...
export const selectCurrentSong = (state: RootState) => state.songs.filter((v) => !state.currentSong.mood || v.mood.includes(state.currentSong.mood))[state.currentSong.song]
