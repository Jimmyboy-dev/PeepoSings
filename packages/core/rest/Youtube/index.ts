...
//     return []
//   } catch (e) {
//     console.error('youtube fetch playlist error')
//     console.error(e)
//     return []
//   }
// }
...
//   const itemsWithoutSkippedIds = (results.items as ytsr.Video[]).filter((item) => omitStreamId !== item.id)

//   const topTrack: ytsr.Video = head(itemsWithoutSkippedIds as ytsr.Video[])
...
//     }
//   } catch (e) {
//     console.error('youtube track search error')
//     console.error(e)
...
//     }
//   } catch (e) {
//     console.error('youtube track get by id')
//     console.error(e)
