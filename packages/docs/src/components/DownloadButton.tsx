  ...
  return (
    <Stack>
      ...
      <div className="flex flex-row items-center justify-evenly gap-1 h-6 w-full">
        ...
        <Anchor className="hover:font-semibold hover:no-underline hover:text-blue-300 transition-colors duration-200 w-1/2" href="https://github.com/Jimmyboy-dev/PeepoSings/releases" target="_blank">
          Previous Versions
        </Anchor>
      </div>
    </Stack>
